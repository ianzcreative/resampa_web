...
header('Content-Type: application/json');
   ...
   function get_daftar_transaksi_sampah_nasabah()
   {
    ...
    . "JOIN tbl_nasabah ON tbl_transaksi_sampah.id_nasabah = tbl_nasabah.id_nasabah JOIN tbl_item_transaksi_sampah ON tbl_transaki_sampah.id_transaksi_sampah = tbl_item_transaksi_sampah.id_transaksi_sampah WHERE tbl_nasabah.nik_nasabah ='".$nik."' ORDER BY id_transaksi_sampah DESC"); 
