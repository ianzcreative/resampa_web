...
header('Content-Type: application/json');
   ...
   function get_daftar_transaksi_sampah_nasabah()
   {
    ...
    . "JOIN tbl_nasabah ON tbl_transaksi_sampah.id_nasabah = tbl_nasabah.id_nasabah WHERE tbl_nasabah.nik_nasabah ='".$nik."' ORDER BY tbl_transaksi_sampah.id_transaksi_sampah DESC"); 
